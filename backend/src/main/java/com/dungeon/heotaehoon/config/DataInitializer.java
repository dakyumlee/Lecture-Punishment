...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        createShopItemsIfNeeded();
        createMentalRecoveryMissionsIfNeeded();
        createRaidBossesIfNeeded();
    ...
    private void createRaidBossesIfNeeded() {
    ...
    private void createMentalRecoveryMissionsIfNeeded() {
        if (mentalRecoveryMissionRepository.count() == 0) {
    ...
    private void createShopItemsIfNeeded() {
        if (shopItemRepository.count() == 0) {
            ...
            System.out.println("✅ 상점 아이템 초기화 완료!");
        }
    }
}
